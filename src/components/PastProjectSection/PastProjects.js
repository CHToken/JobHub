  ...
  return (
    <div className="past-projects card">
      ...
      <div className='d-flex align-items-center justify-content-around'>
          <button onClick={handleSaveClick} className='btn' style={{width:"20%"}}>Save</button>
          <button onClick={handleAddProject} className='btn btn-success' style={{width:"70%"}}>Add Project</button>
      </div>
    </div>
  );
};
